...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/indra0088)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/indra0088
```

A live public deployment of this template is available at [https://indra0088.templates.workers.dev](https://indra0088.templates.workers.dev)
